...
SRC_ROOT = os.path.realpath(os.path.abspath(os.path.dirname(PROJECT_ROOT)))
DEPLOYED_ROOT = os.path.realpath(os.path.abspath(os.path.dirname(SRC_ROOT)))
...
MEDIA_ROOT = os.path.join(DEPLOYED_ROOT, 'media')
